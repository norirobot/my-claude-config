    ...
    try:
        if notification_type == "arrival":
            ...
            if student_name:
                ...
                # 전체 메시지를 하나로 구성 (자연스러운 억양과 간격)
                full_message = f"{student_name}님, 등원하셨습니다."
                print(f"[테스트] 자연스러운 음성 재생 (속도 100): '{full_message}'")
            ...
            if student_name:
                ...
                # 전체 메시지를 하나로 구성 (자연스러운 억양과 간격)
                full_message = f"{student_name}님, 하원하셨습니다."
                print(f"[테스트] 자연스러운 음성 재생 (속도 100): '{full_message}'")
                engine.say(full_message)
                engine.runAndWait()
...
if __name__ == "__main__":
    print("=== 자연스러운 한국어 억양 + 느린 속도 테스트 시작 ===")
    
    print("\n1. 등원 알림 테스트 (홍길동) - 속도 100 + 자연스러운 억양")
    play_notification_sound("arrival", "홍길동")
    
    print("\n잠시 대기...")
    time.sleep(3)
    
    print("\n2. 하원 알림 테스트 (홍길동) - 속도 100 + 자연스러운 억양")
