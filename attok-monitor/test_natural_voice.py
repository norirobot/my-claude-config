...
if __name__ == "__main__":
    print("=== 자연스러운 음성 속도 테스트 시작 ===")
    
    print("\n1. 등원 알림 테스트 (홍길동) - 속도 150")
    play_notification_sound("arrival", "홍길동")
    
    print("\n잠시 대기...")
    time.sleep(3)
    
    print("\n2. 하원 알림 테스트 (홍길동) - 속도 150")
