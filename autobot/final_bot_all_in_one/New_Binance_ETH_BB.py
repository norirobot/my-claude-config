...
time.sleep(0.1)
df_up = myBinance.GetOhlcv(binanceX,Target_Coin_Ticker, '15m')
...
print("\n-----------------------------------------------")
ic_before = myBinance.GetIC(df,-2) #이전캔들의 일목균형표
...
print("-----------------------------------------------")
ic = myBinance.GetIC(df,-1) #현재캔들의 일목균형표
