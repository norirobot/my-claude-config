...
강의를 통해 만든 이더리움을 거래하는 흔들 봇으로 개선된 부분을 아래 코드를 살펴보면서 확인하세요


크론탭에 매 1분마다 실행되게 설정하면 되지만 

*/1 * * * * python3 /var/autobot/binance_auto_ETH.py

30분봉 혹은 15분봉을 볼수도 있는거니 이는 마음 껏 수정하세요!
