...
TopCoinList = myBybit.GetTopCoinList(bybitX,10)
...
for ticker in Tickers:
    ...
    try: 
        ...
        if "/USDT" in ticker:
            ...
            Max_Amount = round(myBybit.GetAmount(TotalMoney,coin_price, 800.0 / TotalMoney ),3) * leverage 
            ...
            if amt == 0:
                ...
                if myBybit.CheckCoinInList(TopCoinList,ticker) == True and NowCoinCnt < MaxCoinCnt:
                    ...
                    time.sleep(0.1)
                    df = myBybit.GetOhlcv(bybitX,Target_Coin_Ticker, '1h')
                    ...
                    if rsi14 >= 60 :
                        ...
                        print(bybitX.create_market_sell_order(Target_Coin_Ticker, buy_amount))
                        ...
                        print(bybitX.create_limit_buy_order(Target_Coin_Ticker, buy_amount, coin_price * (1.0 - target_rate), {'reduce_only': True,'close_on_trigger':True}))
                    ...
                    if rsi14 <= 40 :
                        ...
                        print(bybitX.create_market_buy_order(Target_Coin_Ticker, buy_amount))
                        ...
                        print(bybitX.create_limit_sell_order(Target_Coin_Ticker, buy_amount, coin_price * (1.0 + target_rate), {'reduce_only': True,'close_on_trigger':True}))
                ...
                if hour == 0 or danger_rate > revenue_rate:
                    ...
                    if amt < 0:
                        ...
                        if Max_Amount >= abs_amt + water_buy_amount:
                            ...
                            #숏 포지션을 잡는다
                            print(bybitX.create_market_sell_order(Target_Coin_Ticker, water_buy_amount))
                    ...
                    #양수면 롱 포지션 상태
                        ...
                        if Max_Amount >= abs_amt + water_buy_amount:
                            ...
                            #롱 포지션을 잡는다
                            print(bybitX.create_market_buy_order(Target_Coin_Ticker, water_buy_amount))
