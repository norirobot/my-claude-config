...
const LearningRecordsPageSimple: React.FC = () => {
    ...
    const mockRecords: LearningRecord[] = [
      {
        ...
        date: '2024-12-14',
        type: 'chat',
        title: language === 'ko' ? 'Jennifer와 일상 대화' : 'Daily Chat with Jennifer',
        duration: 30,
        score: 85,
        topics: [
          language === 'ko' ? '일상 대화' : 'Daily Conversation',
          language === 'ko' ? '취미' : 'Hobbies'
        ],
        status: 'completed',
      ...
      },
      {
        ...
        date: '2024-12-13',
        type: 'tutor',
        title: language === 'ko' ? '비즈니스 영어 - 프레젠테이션' : 'Business English - Presentation',
        tutor: 'Jennifer Williams',
        duration: 50,
        score: 92,
        topics: [
          language === 'ko' ? '비즈니스 영어' : 'Business English',
          language === 'ko' ? '프레젠테이션' : 'Presentation'
        ],
        status: 'completed',
      ...
      },
      {
        ...
        date: '2024-12-12',
        type: 'pronunciation',
        title: language === 'ko' ? '발음 교정 - TH 발음' : 'Pronunciation Correction - TH Sound',
        duration: 25,
        score: 78,
        topics: [
          language === 'ko' ? '발음' : 'Pronunciation',
          language === 'ko' ? 'TH 사운드' : 'TH Sound'
        ],
        status: 'completed'
      },
      {
        ...
        date: '2024-12-11',
        type: 'chat',
        title: language === 'ko' ? '여행 영어 - 공항에서' : 'Travel English - At the Airport',
        duration: 35,
        score: 88,
        topics: [
          language === 'ko' ? '여행 영어' : 'Travel English',
          language === 'ko' ? '공항' : 'Airport'
        ],
        status: 'completed'
      },
      {
        ...
        date: '2024-12-10',
        type: 'tutor',
        title: language === 'ko' ? 'Jennifer와 문화 이야기' : 'Cultural Chat with Jennifer',
        tutor: 'Jennifer Williams',
        duration: 45,
        score: 90,
        topics: [
          language === 'ko' ? '문화' : 'Culture',
          language === 'ko' ? '전통' : 'Tradition'
        ],
        status: 'completed'
      }
    ]
            ...
            <Table>
              <TableHead>
                <TableRow>
                  ...
                  <TableCell>{t.learningRecords.topicsLabel}</TableCell>
...
export default LearningRecordsPageSimple